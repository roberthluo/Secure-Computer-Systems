...
def sign_file(digest):
    ...
    print("File is signed! Here is the signed file:", signature)
...
def symmetric_encryption(txt_file):
    key = Fernet.generate_key()
    f = Fernet(key)
    token = f.encrypt(txt_file)
    print("key generated by symmetric_encryption to be encryption", key)
    return {'f':f, 'token':token, 'key':key}

def symmetric_decryption(f, token):
    print("Symmetric_decryption:")
...
if __name__ == "__main__":
    ...
    print("----------------------------------------------")
    token_dict = symmetric_encryption(file_txt)
    cipertext = encryption(file_txt, token_dict['key'])
    symmetric_decryption(token_dict['f'], token_dict['token'])
    token = decryption(cipertext)
